...
public class buatLowongan extends javax.swing.JFrame {
    ...
    public buatLowongan(String usernameParam) {
        ...
        try {
            String query = "SELECT id_perusahaan FROM tb_perusahaan JOIN tb_users ON tb_perusahaan.id_user = tb_users.id_user WHERE username = ?";
            PreparedStatement stmt = conn.prepareStatement(query);
            stmt.setString(1, usernameParam);
            ResultSet rs = stmt.executeQuery();
            if (rs.next()) {
                id_perusahaan = rs.getInt("id_perusahaan");
            }
    ...
    private void initComponents() {
        ...
        namaperu.setText("Buat Lowongan");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField3.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Daerah tidak boleh kosong!");
            return;
        }
        try {
            String query = "INSERT INTO tb_lowongan (id_perusahaan, nama_lowongan, deskripsi, gaji, enabled, kategori, date_posted, daerah) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement stmt = conn.prepareStatement(query);
            stmt.setInt(1, id_perusahaan);
